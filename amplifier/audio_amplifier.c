...
static zara_device_t *zara_dev = NULL;
        ...
        hw_device_t **device)
{
    ...
    zara_dev = calloc(1, sizeof(zara_device_t));
    if (!zara_dev) {
    ...
    zara_dev->amp_dev.common.tag = HARDWARE_DEVICE_TAG;
    zara_dev->amp_dev.common.module = (hw_module_t *) module;
    ...
    zara_dev->amp_dev.enable_input_devices = NULL;
    zara_dev->amp_dev.enable_output_devices = amp_enable_output_devices;
    zara_dev->amp_dev.set_mode = amp_set_mode;
    zara_dev->amp_dev.output_stream_start = amp_output_stream_start;
    zara_dev->amp_dev.input_stream_start = NULL;
